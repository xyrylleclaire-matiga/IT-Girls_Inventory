...
Public Class frmUniformView
    ...
    Private Sub frmUniformView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        displayApplication()
        CustomizeListView()
    End Sub
    ...
    Private Sub displayApplication(Optional searchQuery As String = "")
        Try
            ...
            Dim sql As String = "SELECT * FROM tbluniforms WHERE category = 'School Uniform'"
    ...
    'FOR SELECTINGGGG
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView2.SelectedIndexChanged
        If ListView2.SelectedItems.Count > 0 Then
            ...
            txtQuantity.Text = selectedItem.SubItems(4).Text
