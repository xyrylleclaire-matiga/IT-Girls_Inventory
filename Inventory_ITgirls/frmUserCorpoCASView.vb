...
Public Class frmUserCorpoCASView
    ...
    Private Sub UniformView()
        Try
            ...
            Dim sql As String = "SELECT * FROM tbluniforms WHERE item_name=@item_name AND gender=@gender AND size=@size AND level='College' AND category='Corporate Attire' AND Course='Bachelor of Science in Psychology'"
            ...
            Else
                lblPrice.Text = "—"
                lblStatus.Text = "No Record Found" ' Binago ko ang mensahe para mas malinaw
                lblStatus.ForeColor = Color.Red
            End If
