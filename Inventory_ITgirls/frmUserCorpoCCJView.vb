...
Public Class frmUserCorpoCCJView
    ...
    Private Sub UniformView()
        Try
            ...
            Dim sql As String = "SELECT * FROM tbluniforms WHERE item_name=@item_name AND gender=@gender AND size=@size AND level='College' AND category='Corporate Attire' AND Course='Bachelor of Science in Criminal Justice'" ' Inayos ang Course name at tinanggal ang sobrang parenthesis
    ...
    Private Sub rdoM_CheckedChanged(sender As Object, e As EventArgs)
        If rdoM.Checked And cmbItemName.Text <> "" And cmbSizes.Text <> "" Then
            UniformView()
        End If
    End Sub

    Private Sub rdoF_CheckedChanged(sender As Object, e As EventArgs)
        If rdoF.Checked And cmbItemName.Text <> "" And cmbSizes.Text <> "" Then
            UniformView()
        End If
    End Sub

    Private Sub rdoU_CheckedChanged(sender As Object, e As EventArgs)
        If rdoU.Checked And cmbItemName.Text <> "" And cmbSizes.Text <> "" Then
            UniformView()
        End If
    End Sub

    Private Sub frmUserCorpoCCJView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
