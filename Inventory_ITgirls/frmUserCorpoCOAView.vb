...
Public Class frmUserCorpoCOAView
    ...
    Private Sub UniformView()
        Try
            ...
            If cmbItemName.Text.Trim() = "" Or cmbSizes.Text.Trim() = "" Then
                ...
                Exit Sub
            End If
            Dim sql As String = "SELECT * FROM tbluniforms WHERE item_name=@item_name AND gender=@gender AND size=@size AND level='College' AND category='Corporate Attire' AND Course = 'Bachelor of Science in Accountancy'"
    ...
    Private Sub cmbSizes_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbSizes.SelectedIndexChanged
        ...
        End If
    End Sub
    Private Sub frmUserCorpoCOAView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
