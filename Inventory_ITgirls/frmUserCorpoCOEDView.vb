...
Public Class frmUserCorpoCOEDView
    ...
    Private Sub UniformView()
        Try
            ...
            Dim sql As String = "SELECT * FROM tbluniforms WHERE item_name=@item_name AND gender=@gender AND size=@size AND level='College' AND category='Corporate Attire' AND Course = 'Bachelor of Science in Education'"
        ...
        If cmbItemName.Text <> "" Then
            ...
            Select Case selectedItem
                ...
                Case "polo"
                    ...
                    'Case "skirt" ' Idinagdag para sa Skirt (Kung kasama sa iyong cmbItemName)
                    '    rdoM.Enabled = False
                    '    rdoU.Enabled = False
                    '    rdoF.Checked = True
    ...
    Private Sub frmUserCorpoCOEDView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
