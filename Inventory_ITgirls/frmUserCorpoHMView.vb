...
Public Class frmUserCorpoHMView
    ...
    Private Sub UniformView()
        Try
            ...
            If cmbItemName.Text.Trim() = "" Or cmbSizes.Text.Trim() = "" Then
                ...
                Exit Sub
            End If
            Dim sql As String = "SELECT * FROM tbluniforms WHERE item_name=@item_name AND gender=@gender AND size=@size AND level='College' AND category='Corporate Attire' AND Course = 'Bachelor of Science in Hospitality Management'"
    ...
    Private Sub frmUserCorpoHMView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
