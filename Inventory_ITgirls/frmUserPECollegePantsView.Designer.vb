...
Partial Class frmUserPECollegePantsView
    ...
    Private Sub InitializeComponent()
        ...
        lblStatus.Location = New Point(62, 282)
        ...
        lblPrice.Location = New Point(397, 20)
        lblPrice.Name = "lblPrice"
        lblPrice.Size = New Size(48, 32)
        lblPrice.TabIndex = 77
        lblPrice.Text = "— "
        ' 
        ' cmbGender
        ' 
        ...
        Label8.Location = New Point(376, 27)
        Label8.Name = "Label8"
        ...
        Controls.Add(Panel1)
        Name = "frmUserPECollegePantsView"
        Text = "frmCollegePEPants"
