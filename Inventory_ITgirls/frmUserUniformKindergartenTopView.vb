...
Public Class frmUserUniformKindergartenTopView
    Private Sub UniformView()
        Try
            ...
            Dim sql As String = "SELECT * FROM tbluniforms WHERE item_name=@item_name AND gender=@gender AND size=@size AND level='Kindergarten'"
    ...
    Private Sub frmUserUniformKindergartenTopView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
